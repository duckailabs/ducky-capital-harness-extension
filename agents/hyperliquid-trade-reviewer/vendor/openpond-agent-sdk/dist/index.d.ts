...
export type AgentChannelId = "openpond_chat" | "microsoft_teams" | "slack" | "mcp" | "api" | "schedule" | "manual";
...
export type AgentContext = {
    trace: {
        ...
        span<TResult>(kind: "workflow" | "step" | "model" | "tool" | "action" | "eval" | "skill", name: string, run: () => Promise<TResult>, payload?: Record<string, unknown>): Promise<TResult>;
    };
    ...
    runCommand(command: string, options?: Record<string, unknown>): Promise<{
...
export type ActionSetupRequirementDefinition = {
    kind: "channel" | "connection" | "integration" | "env" | "volume" | "schedule" | "package" | "python" | "native_tool";
    name: string;
    required?: boolean;
    description?: string;
    command?: string;
...
export type WorkflowDefinition = {
    ...
    name: string;
    description?: string;
    run: (ctx: AgentContext, input: Record<string, unknown>) => Promise<AgentChatResult>;
};
...
export type EvalActionInput = Record<string, unknown> & Partial<AgentChatInput>;
export type EvalContext = {
    send(input: EvalActionInput & {
        prompt: string;
    }): Promise<AgentChatResult>;
    runAction(actionName: string, input: EvalActionInput): Promise<AgentChatResult>;
...
export type ActionTargetDefinition = {
    ...
    run?: (ctx: AgentContext, input: AgentChatInput, catalog: ActionCatalogEntry[]) => Promise<AgentChatResult>;
} | {
    kind: "intent-router";
...
export type EditableResultMode = "patch_only" | "commit_to_runtime_ref" | "create_branch" | "open_pr" | "checkpoint_only";
...
export declare function defineAgentProject(definition: AgentProjectDefinition): AgentProjectDefinition;
export declare function defineAgent(definition: AgentProjectDefinition): AgentProjectDefinition;
export declare function defineAgent(definition: Omit<LocalAgentDefinition, "kind">): LocalAgentDefinition;
export declare function defineLocalAgent(definition: Omit<LocalAgentDefinition, "kind">): LocalAgentDefinition;
export declare function defineRemoteAgent(definition: Omit<RemoteAgentReferenceDefinition, "kind">): RemoteAgentReferenceDefinition;
export declare function defineMcpClientConnection(definition: Omit<McpClientConnectionDefinition, "kind">): McpClientConnectionDefinition;
export declare function defineIntent<TInput = AgentChatInput>(definition: Omit<IntentDefinition<TInput>, "kind">): IntentDefinition<TInput>;
export declare function defineIntentRouter(definition: Omit<IntentRouterDefinition, "kind">): IntentRouterDefinition;
export declare function defineChannel(definition: Omit<ChannelDefinition, "kind">): ChannelDefinition;
export declare function defineWorkflow(definition: Omit<WorkflowDefinition, "kind">): WorkflowDefinition;
export declare function defineTool(definition: Omit<ToolDefinition, "kind">): ToolDefinition;
export declare function defineEval(definition: Omit<EvalDefinition, "kind">): EvalDefinition;
export declare function defineSchedule(definition: Omit<ScheduleDefinition, "kind">): ScheduleDefinition;
export declare function defineInstructions(definition: InstructionsDefinition["source"] | Omit<InstructionsDefinition, "kind">): InstructionsDefinition;
export declare function defineSkill(definition: Omit<SkillDefinition, "kind">): SkillDefinition;
export declare function action(name: string, definition: Omit<ActionDefinition, "name">): ActionDefinition;
export declare function defineAction(id: string, definition: Omit<ActionDefinition, "id" | "name"> & {
    name?: string;
}): ActionDefinition;
export declare function defineAction(definition: Omit<ActionDefinition, "name"> & {
    id: string;
    name?: string;
}): ActionDefinition;
export declare function editable(definition: Omit<EditablePolicyDefinition, "kind">): EditablePolicyDefinition;
...
export declare function defineIntegration(definition: IntegrationDefinition): IntegrationDefinition;
export declare function defineEnvSecret(name: string, definition?: Omit<EnvSecretDefinition, "kind" | "name">): EnvSecretDefinition;
export declare const env: {
    variable(name: string, definition?: Omit<EnvSecretDefinition, "kind" | "name" | "secret">): EnvSecretDefinition;
};
export declare const secret: {
    env(name: string, definition?: Omit<EnvSecretDefinition, "kind" | "name" | "secret">): EnvSecretDefinition;
};
export declare function volume(name: string, mountPath: string, definition: Omit<VolumeDefinition, "name" | "mountPath">): VolumeDefinition;
export declare const defineVolume: typeof volume;
export declare const schedule: {
    cron(name: string, definition: Omit<ScheduleDefinition, "kind" | "name" | "scheduleType">): ScheduleDefinition;
    rate(name: string, definition: Omit<ScheduleDefinition, "kind" | "name" | "scheduleType">): ScheduleDefinition;
};
export declare function runAgentAction(_agent: AgentProjectDefinition, _actionName: string, _options?: Record<string, unknown>): Promise<void>;
